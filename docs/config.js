window.NEUROFILES_SITE_CONFIG = {
  ...
  firebaseConfig: {
    apiKey: "AIzaSyDCaNlUDLWWYmAVonDrsf-L4TZmPXcSzm8",
    authDomain: "neuro-files-beta-1.firebaseapp.com",
    projectId: "neuro-files-beta-1",
    storageBucket: "neuro-files-beta-1.firebasestorage.app",
    messagingSenderId: "523809619608",
    appId: "1:523809619608:web:c7b9c615d03c4596f9daed",
    measurementId: "G-YJ7WPWNFZN"
  },
  firebasePortal: {
    profilesCollection: "portalProfiles",
    workspacesCollection: "portalWorkspaces",
    subscriptionsCollection: "portalSubscriptions",
    eventsCollection: "portalEvents",
